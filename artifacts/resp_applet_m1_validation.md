...
| Streamlit module smoke | bare mode | pass | `python -m sofa_resp_sim.web.applet_streamlit` executed; expected ScriptRunContext warnings outside `streamlit run` |

## Notes
- Milestone 1 scope implemented under `python/src/sofa_resp_sim/web/`.
