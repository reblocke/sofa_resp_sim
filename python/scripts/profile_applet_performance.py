...
from sofa_resp_sim.web.app_services import run_single_scenario
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Profile Streamlit applet single-scenario service runtime."
    )
...
def main() -> int:
    ...
    print("Applet performance benchmark (single scenario)")
    for key in (
        "n_reps",
        "repeats",
        "seed",
